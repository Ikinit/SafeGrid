    ...
    <div class="relative min-h-screen w-full min-w-[670px] flex items-center justify-center overflow-hidden bg-white">
        ...
        <div class="w-full max-w-7xl flex flex-col min-[1250px]:flex-row items-center justify-center gap-12 min-[1250px]:gap-32 px-6 lg:px-12">
            ...
            <div class="bg-white rounded-[1rem] p-8 w-full max-w-sm shadow-[0_2px_10px_rgba(59,130,246,0.15)] border border-blue-50">
                <h2 class="text-center text-3xl font-bold mb-6 text-[#1e3a5f]" style="font-family: 'Segoe UI', system-ui, sans-serif;">Login</h2>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        <x-input-label for="username" :value="__('Username:')" class="text-[#64748b] text-sm font-medium" />
                        <input id="username" type="text" name="username" value="{{ old('username') }}" required autofocus autocomplete="username" placeholder="Enter username"
                    ...
                    <div class="mb-2">
                        <x-input-label for="password" :value="__('Password:')" class="text-[#64748b] text-sm font-medium" />
